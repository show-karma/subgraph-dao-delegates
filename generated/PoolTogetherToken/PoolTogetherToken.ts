...
export class PoolTogetherToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class PoolTogetherToken extends ethereum.SmartContract {
  static bind(address: Address): PoolTogetherToken {
    return new PoolTogetherToken("PoolTogetherToken", address);
  }
  ...
  checkpoints(
    param0: Address,
    param1: BigInt
  ): PoolTogetherToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new PoolTogetherToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<PoolTogetherToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new PoolTogetherToken__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
