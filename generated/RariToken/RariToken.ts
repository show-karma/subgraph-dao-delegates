...
export class RariToken__checkpointsResultValue0Struct extends ethereum.Tuple {
...
export class RariToken extends ethereum.SmartContract {
  static bind(address: Address): RariToken {
    return new RariToken("RariToken", address);
  }
  ...
  checkpoints(
    account: Address,
    pos: BigInt
  ): RariToken__checkpointsResultValue0Struct {
    let result = super.call(
      "checkpoints",
    ...
    return result[0].toTuple() as RariToken__checkpointsResultValue0Struct;
  }

  try_checkpoints(
    account: Address,
    pos: BigInt
  ): ethereum.CallResult<RariToken__checkpointsResultValue0Struct> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):((uint32,uint224))",
      [
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as RariToken__checkpointsResultValue0Struct
    );
  }
