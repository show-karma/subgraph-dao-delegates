...
export class IndexedToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class IndexedToken extends ethereum.SmartContract {
  static bind(address: Address): IndexedToken {
    return new IndexedToken("IndexedToken", address);
  }
  ...
  checkpoints(
    param0: Address,
    param1: BigInt,
  ): IndexedToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new IndexedToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt,
  ): ethereum.CallResult<IndexedToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new IndexedToken__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
