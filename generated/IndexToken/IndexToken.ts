...
export class IndexToken__checkpointsResultValue0Struct extends ethereum.Tuple {
...
export class IndexToken extends ethereum.SmartContract {
  ...
  checkpoints(
    account: Address,
    pos: BigInt
  ): IndexToken__checkpointsResultValue0Struct {
    let result = super.call(
      "checkpoints",
    ...
    return result[0].toTuple() as IndexToken__checkpointsResultValue0Struct;
  }

  try_checkpoints(
    account: Address,
    pos: BigInt
  ): ethereum.CallResult<IndexToken__checkpointsResultValue0Struct> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):((uint32,uint224))",
      [
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as IndexToken__checkpointsResultValue0Struct
    );
  }
