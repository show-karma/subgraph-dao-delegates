...
export class CompoundGovernanceToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class CompoundGovernanceToken extends ethereum.SmartContract {
  static bind(address: Address): CompoundGovernanceToken {
    return new CompoundGovernanceToken("CompoundGovernanceToken", address);
  }
