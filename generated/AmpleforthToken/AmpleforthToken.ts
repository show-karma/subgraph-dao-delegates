...
export class AmpleforthToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class AmpleforthToken extends ethereum.SmartContract {
  static bind(address: Address): AmpleforthToken {
    return new AmpleforthToken("AmpleforthToken", address);
  }
  ...
  checkpoints(
    param0: Address,
    param1: BigInt,
  ): AmpleforthToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new AmpleforthToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt,
  ): ethereum.CallResult<AmpleforthToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new AmpleforthToken__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
