...
export class Connext__checkpointsResultValue0Struct extends ethereum.Tuple {
...
export class Connext extends ethereum.SmartContract {
  static bind(address: Address): Connext {
    return new Connext("Connext", address);
  }
  ...
  checkpoints(
    account: Address,
    pos: BigInt
  ): Connext__checkpointsResultValue0Struct {
    let result = super.call(
      "checkpoints",
    ...
    return changetype<Connext__checkpointsResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_checkpoints(
    account: Address,
    pos: BigInt
  ): ethereum.CallResult<Connext__checkpointsResultValue0Struct> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):((uint32,uint224))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<Connext__checkpointsResultValue0Struct>(value[0].toTuple())
    );
  }
