...
export class GTCDistChanged extends ethereum.Event {
  get params(): GTCDistChanged__Params {
    return new GTCDistChanged__Params(this);
  }
}

export class GTCDistChanged__Params {
  _event: GTCDistChanged;

  constructor(event: GTCDistChanged) {
    this._event = event;
  }
...
export class GitcoinToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class GitcoinToken extends ethereum.SmartContract {
  static bind(address: Address): GitcoinToken {
    return new GitcoinToken("GitcoinToken", address);
  }
  ...
  GTCDist(): Address {
    let result = super.call("GTCDist", "GTCDist():(address)", []);

    return result[0].toAddress();
  }

  try_GTCDist(): ethereum.CallResult<Address> {
    let result = super.tryCall("GTCDist", "GTCDist():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  checkpoints(
    param0: Address,
    param1: BigInt
  ): GitcoinToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new GitcoinToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<GitcoinToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new GitcoinToken__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
...
export class DelegateOnDistCall extends ethereum.Call {
  get inputs(): DelegateOnDistCall__Inputs {
    return new DelegateOnDistCall__Inputs(this);
  }

  get outputs(): DelegateOnDistCall__Outputs {
    return new DelegateOnDistCall__Outputs(this);
  }
}

export class DelegateOnDistCall__Inputs {
  _call: DelegateOnDistCall;

  constructor(call: DelegateOnDistCall) {
    this._call = call;
  }
...
export class DelegateOnDistCall__Outputs {
  _call: DelegateOnDistCall;
...
export class SetGTCDistCall extends ethereum.Call {
  get inputs(): SetGTCDistCall__Inputs {
    return new SetGTCDistCall__Inputs(this);
  }

  get outputs(): SetGTCDistCall__Outputs {
    return new SetGTCDistCall__Outputs(this);
  }
}

export class SetGTCDistCall__Inputs {
  _call: SetGTCDistCall;

  constructor(call: SetGTCDistCall) {
    this._call = call;
  }

  get GTCDist_(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class SetGTCDistCall__Outputs {
  _call: SetGTCDistCall;
