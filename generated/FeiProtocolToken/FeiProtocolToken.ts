...
export class FeiProtocolToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class FeiProtocolToken extends ethereum.SmartContract {
  static bind(address: Address): FeiProtocolToken {
    return new FeiProtocolToken("FeiProtocolToken", address);
  }
  ...
  checkpoints(
    param0: Address,
    param1: BigInt
  ): FeiProtocolToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new FeiProtocolToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<FeiProtocolToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new FeiProtocolToken__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
