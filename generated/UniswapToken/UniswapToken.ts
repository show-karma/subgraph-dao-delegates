...
export class UniswapToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapToken extends ethereum.SmartContract {
  static bind(address: Address): UniswapToken {
    return new UniswapToken("UniswapToken", address);
  }
  ...
  checkpoints(
    param0: Address,
    param1: BigInt
  ): UniswapToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new UniswapToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<UniswapToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new UniswapToken__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
